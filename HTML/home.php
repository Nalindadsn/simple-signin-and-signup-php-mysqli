...
echo '<li class="navbar-item"><a href="logout.php" class="navbar-link bg-danger">signout</a></li>';
    ...
    <section class="hero-section">
        <div class="container">
            <div class="content">
                <div class="text-box">
                <?php if(isset($_SESSION['fullname'])) echo 'Hello '.$_SESSION['fullname'] ?>
                    ...
                    <div class="buttons">
                        <a href="../HTML/about us.html" class="btn">Read More</a>
                        <a href="../HTML/login.php" class="btn">    Start</a>
                    </div>
                </div>
                <div class="image-box">
                    <img src="../IMAGES/new bg 1.jpeg" alt="Mind Educations">
                </div>
            </div>
        </div>
    </section>
...
<div class="box-container">
    <div class="box">
        <img src="../IMAGES/Bisuness.jpeg" alt="">
        <div class="info">
            <h2><i>Business</i></h2>
